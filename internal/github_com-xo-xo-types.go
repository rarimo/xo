// Code generated by 'yaegi extract gitlab.com/rarify-protocol/xo/types'. DO NOT EDIT.

package internal

import (
	"gitlab.com/rarify-protocol/xo/types"
	"reflect"
)

func init() {
	Symbols["gitlab.com/rarify-protocol/xo/types/types"] = map[string]reflect.Value{
