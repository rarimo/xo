// Code generated by 'yaegi extract gitlab.com/rarimo/xo/types'. DO NOT EDIT.

package internal

import (
	"gitlab.com/rarimo/xo/types"
	"reflect"
)

func init() {
	Symbols["gitlab.com/rarimo/xo/types/types"] = map[string]reflect.Value{
