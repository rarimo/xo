// Code generated by 'yaegi extract gitlab.com/rarify-protocol/templates'. DO NOT EDIT.
...
func init() {
	Symbols["gitlab.com/rarify-protocol/templates/templates"] = map[string]reflect.Value{
