// Code generated by 'yaegi extract gitlab.com/rarify-protocol/xo/templates/createdbtpl'. DO NOT EDIT.
...
func init() {
	Symbols["gitlab.com/rarify-protocol/xo/templates/createdbtpl/createdbtpl"] = map[string]reflect.Value{
