// Code generated by 'yaegi extract github.com/rarimo/xo/types'. DO NOT EDIT.

package internal

import (
	"github.com/rarimo/xo/types"
	"reflect"
)

func init() {
	Symbols["github.com/rarimo/xo/types/types"] = map[string]reflect.Value{
