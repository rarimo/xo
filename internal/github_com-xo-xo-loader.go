// Code generated by 'yaegi extract gitlab.com/rarify-protocol/xo/loader'. DO NOT EDIT.
...
func init() {
	Symbols["gitlab.com/rarify-protocol/xo/loader/loader"] = map[string]reflect.Value{
