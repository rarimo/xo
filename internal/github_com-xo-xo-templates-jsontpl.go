// Code generated by 'yaegi extract github.com/rarimo/xo/templates/jsontpl'. DO NOT EDIT.
...
func init() {
	Symbols["github.com/rarimo/xo/templates/jsontpl/jsontpl"] = map[string]reflect.Value{
