// Code generated by 'yaegi extract gitlab.com/rarimo/xo/templates/createdbtpl'. DO NOT EDIT.
...
func init() {
	Symbols["gitlab.com/rarimo/xo/templates/createdbtpl/createdbtpl"] = map[string]reflect.Value{
