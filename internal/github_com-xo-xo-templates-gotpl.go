// Code generated by 'yaegi extract gitlab.com/rarify-protocol/templates/gotpl'. DO NOT EDIT.
...
func init() {
	Symbols["gitlab.com/rarify-protocol/templates/gotpl/gotpl"] = map[string]reflect.Value{
