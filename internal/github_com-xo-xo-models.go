// Code generated by 'yaegi extract gitlab.com/rarify-protocol/xo/models'. DO NOT EDIT.
...
func init() {
	Symbols["gitlab.com/rarify-protocol/xo/models/models"] = map[string]reflect.Value{
