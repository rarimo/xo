// Code generated by 'yaegi extract gitlab.com/rarify-protocol/loader'. DO NOT EDIT.
...
func init() {
	Symbols["gitlab.com/rarify-protocol/loader/loader"] = map[string]reflect.Value{
