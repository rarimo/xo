// Code generated by 'yaegi extract gitlab.com/rarify-protocol/types'. DO NOT EDIT.

package internal

import (
	"gitlab.com/rarify-protocol/types"
	"reflect"
)

func init() {
	Symbols["gitlab.com/rarify-protocol/types/types"] = map[string]reflect.Value{
