// Code generated by 'yaegi extract gitlab.com/rarify-protocol/xo/templates/gotpl'. DO NOT EDIT.
...
func init() {
	Symbols["gitlab.com/rarify-protocol/xo/templates/gotpl/gotpl"] = map[string]reflect.Value{
